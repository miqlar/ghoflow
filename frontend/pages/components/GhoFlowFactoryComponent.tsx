...
import { Address, useAccount, useContractWrite, usePrepareContractWrite, useContractRead } from 'wagmi';
...
const GhoFlowFactoryComponent = () => {
    ...
    const { data: ethValueData, isError: isEthValueError, isLoading: isEthValueLoading } = useContractRead({
    ...
    const handleCreateStream = async () => {
        ...
        try {
            const transaction = await createEthStream();
